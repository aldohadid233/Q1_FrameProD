...
#t01 th {
  ...
  <body>
    ...
    <div class="container">
      <img class="img-fluid rounded about-heading-img mb-3 mb-lg-0" src="img/calories.jpg" alt="">
      <div class="about-heading-content">
        <div class="row">
          <div class="col-xl-9 col-lg-10 mx-auto">
            <div class="bg-faded rounded p-5">
              <h2 class="section-heading mb-4">
                <span class="section-heading-upper">Bye Obesity, Hello Healthy Life</span>
                <span class="section-heading-lower">About My Website</span>
              </h2>
              <p>There are many cases of obesity in Indonesia. I offer a calorie counter application service so that people can find out their calorie needs per day so that the incoming calories are not excessive</p>
            </div>
          </div>
        </div>
      </div>
